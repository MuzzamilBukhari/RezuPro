            ...
            <div className="space-y-6">
              <section>
                ...
                <p className="text-xs md:text-sm">
                  ...
                  in networking principles, with a focus on Cisco technologies.
                  Recently completed CCNA and currently pursuing Routing and
                  Switching certification. Seeking opportunities to apply
                  theoretical knowledge and hands-on skills in a dynamic
